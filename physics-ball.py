...
def move_ball(): # function that moves ball every 30 ms
...
omega = -0.12 # initial angular velocity
g = 1.5 # acceleration of gravity
mu = 1 # friction coefficient
I = 0.6 # moment of inertia of the ball
k = 0.99 # coefficient of recovery
...
ball_pos = (20, 500) # initial position of ball
